...
public class HardwareActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.hardwareactivity);
		...
		btCalculate.setOnClickListener(new OnClickListener() {			
			...
			public void onClick(View v) {
				...
				//editor providing a method to add preference content
					...
					editor.commit();
					startActivity(new Intent(HardwareActivity.this, CostActivity.class));
				}
				else
					{
					//display toast message if the radio button is not selected		
					Toast.makeText(HardwareActivity.this, "Please select from, Onsite or Remote options ", Toast.LENGTH_LONG).show();
					} 
				}
